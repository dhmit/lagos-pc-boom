    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('obj_num', models.CharField(max_length=20, null=True, verbose_name='Object Number')),
                ...
                ('num_of_pages', models.CharField(max_length=10, null=True, verbose_name='Page Number(s)')),
                ('subject', models.CharField(max_length=100, null=True)),
                ('language', models.CharField(max_length=30, null=True)),
                ('genre', models.CharField(max_length=50, null=True)),
                ('notes', models.CharField(max_length=100, null=True)),
                ('specific_notes', models.CharField(max_length=200, null=True, verbose_name='Specific Notes')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='renditions', to='home.lagosimage')),
            ],
            options={
